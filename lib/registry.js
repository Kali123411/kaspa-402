...
export async function getListings() {
  ...
  // Curated SEED is trusted as-is; open submissions must also clear the price floor (anti-dust/spam).
  return [...SEED, ...subs.filter(meetsPriceFloor)].filter((l) => validateListing(l).ok);
}
