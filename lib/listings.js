...
export const SEED = [
  ...
  },
  {
    ...
    description: "Grounded answers about Kaspa from a retrieval knowledge base — won't hallucinate Kaspa facts, and returns its sources. Append `?question=…`; each call settles 0.5 KAS via x402 `exact` on mainnet. Ask about GHOSTDAG, KRC-20, covenants, Crescendo/Toccata, fees, and more.",
