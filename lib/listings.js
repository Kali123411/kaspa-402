...
export const SEED = [
  ...
  },
  {
    ...
    description: 'Pay-per-call text summarization on llama3.1:8b. Append `?text=…` to the URL; each call settles 0.2 KAS via x402 `exact` (standard-native) and returns a 1–2 sentence summary.',
