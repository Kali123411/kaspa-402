...
export const CAP_INFO = {
  ...
  'proof-of-reserve': { what: 'Control-proven reserve attestation for Kaspa — a claimant signs a recent block hash with each address key, and you get a signed, self-verifiable statement of the total KAS they provably control at a point in time, with freshness and a per-address breakdown. Proof of reserves (assets), not solvency.', send: '{ "claimantLabel": "…", "challengeBlock": "<recent block hash>", "claims": [ { "address": "kaspa:…", "publicKey": "…", "signature": "…" } ], "thresholdKas": 1000 }', get: '{ "attestation": { "provenControlledKas": …, "fresh": …, "atDaaScore": … }, "serviceSignature": { … }, "verifyRecipe": "…" }' },
};
