...
// Marketplace price floor for OPEN submissions: a per-call price below this is dust/spam-prone (small
// on-chain outputs carry heavy KIP-9 storage mass), so open submissions must meet it. The curated SEED
// is exempt — it's your own list to stand behind.
export const MIN_AMOUNT_SOMPI = 50000000; // 0.5 KAS
export const meetsPriceFloor = (l) => Number.isFinite(Number(l?.amountSompi)) && Number(l.amountSompi) >= MIN_AMOUNT_SOMPI;
